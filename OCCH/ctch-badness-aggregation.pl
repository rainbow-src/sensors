...
# This is an implementation of the occh-badness algorithm (with data aggregation) as presented in the paper:
...
sub print_results {
	...
	printf "# %s\n", '$Id: ctch-badness-aggregation.pl 1481 2011-01-23 21:37:04Z jim $';
}
